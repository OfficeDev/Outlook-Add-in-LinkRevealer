...
ms.date: 05/11/2021
---
# Outlook add-in: Finds and parses all links in the body of an email
This Outlook add-in is no longer supported and many of the components mentioned are unavailable. We keep this sample as an example only. If you're able to update this sample, your contribution is greatly appreciated! Simply create a PR with your changes and request a review by adding lindalu-MSFT as a reviewer.
**Table of contents**
...
In this sample we show you how to use the [JavaScript API for Office](https://docs.microsoft.com/javascript/api/overview?view=excel-js-preview) to create an Outlook add-in that parses the body of an email looking for hyperlinks. The following image is a picture of the scenario in question (in the Outlook on the web).

 ![Outlook add-in that parses the body of an email looking for hyperlinks](/readme-images/screen2.PNG)
...
![Command button in the ribbon](/readme-images/commandbutton.png)
...
This solution was created in [Visual Studio](https://docs.microsoft.com/#Tools_CreatingWithVS). It consists of two projects - LinkRevealer and LinkRevealerWeb. Here's a list of the key files within those projects. 

### LinkRevealer project

* [```LinkRevealer.xml```](https://github.com/OfficeDev/Outlook-Add-in-LinkRevealer/blob/master/LinkRevealer/LinkRevealerManifest/LinkRevealer.xml) The [manifest file](https://docs.microsoft.com/office/dev/add-ins/overview/office-add-ins) for the Word add-in.
...
![Launch the add-in from the add-in app bar](readme-images/screen1.PNG)
